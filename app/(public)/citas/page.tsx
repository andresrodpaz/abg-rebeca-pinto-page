    ...
    <main className="min-h-screen bg-cream py-16 px-4 sm:px-6 lg:px-8" style={{ background: 'linear-gradient(160deg, oklch(0.97 0.012 85) 0%, oklch(0.94 0.018 80) 100%)' }}>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <span
            className="inline-flex items-center gap-1.5 text-xs tracking-[0.18em] uppercase font-sans font-medium mb-4"
          ...
          <p className="text-warm-gray text-sm max-w-md mx-auto leading-relaxed font-sans">
            Elige un día y hora disponibles. Recibirás un email con los datos bancarios para confirmar la cita con el pago de la consulta (50&nbsp;€).
          </p>
        </div>
        ...
        {step === 'confirmation' && result && (
          <div
            className="rounded-2xl p-7 md:p-10 max-w-2xl mx-auto text-center"
            style={{
              background: 'white',
              boxShadow: '0 4px 6px -1px oklch(0.32 0.12 15 / 0.06), 0 20px 60px -10px oklch(0.32 0.12 15 / 0.12), 0 0 0 1px oklch(0.88 0.015 80)',
            }}
          >
            <div
              ...
              style={{
                ...
                boxShadow: '0 8px 24px oklch(0.52 0.15 145 / 0.35)',
              }}
            >
              <CheckCircle className="w-8 h-8" style={{ color: 'white' }} />
            </div>

            <h2 className="font-serif text-2xl font-bold mb-2" style={{ color: 'oklch(0.22 0.005 0)', letterSpacing: '-0.02em' }}>
              Solicitud de cita recibida
            </h2>
            <p className="text-sm font-sans leading-relaxed mb-2" style={{ color: 'oklch(0.55 0.008 50)' }}>
              Tu solicitud para el{' '}
              <strong style={{ color: 'oklch(0.22 0.005 0)' }} className="capitalize">{formatDate(result.slot.date)}</strong>{' '}
              a las <strong style={{ color: 'oklch(0.22 0.005 0)' }}>{result.slot.time.slice(0, 5)} h</strong> ha sido recibida correctamente.
            </p>
            <p className="text-sm font-sans leading-relaxed mb-4 max-w-md mx-auto" style={{ color: 'oklch(0.55 0.008 50)' }}>
              Para confirmar definitivamente tu cita, realiza el pago de la consulta (<strong>50 €</strong>) por transferencia o Bizum y <strong>envíanos el comprobante por WhatsApp</strong>.
            </p>
            <a
              href={result?.whatsappUrl || '#'}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-sans font-semibold mb-8 transition-all duration-200"
              style={{
            ...
            <div
              ...
              style={{ background: 'linear-gradient(135deg, oklch(0.32 0.12 15), oklch(0.24 0.10 15))' }}
            >
              <h3
                className="font-serif text-lg font-semibold mb-4"
                style={{ color: 'oklch(0.76 0.10 80)', letterSpacing: '-0.01em' }}
              >
                Datos de pago
              </h3>
              <pre
                className="font-sans text-sm leading-relaxed whitespace-pre-wrap"
                style={{ color: 'oklch(0.97 0.012 85 / 0.82)' }}
              >
                {result.bankDetails}
              </pre>
            </div>
            ...
            <a
              href="/"
              className="inline-block px-8 py-3.5 text-sm font-sans font-semibold rounded-xl transition-all duration-200"
              style={{
                background: 'linear-gradient(135deg, oklch(0.32 0.12 15), oklch(0.42 0.12 15))',
                color: 'oklch(0.97 0.012 85)',
                boxShadow: '0 4px 14px oklch(0.32 0.12 15 / 0.30)',
              }}
              onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.transform = 'translateY(-1px)'; (e.currentTarget as HTMLAnchorElement).style.boxShadow = '0 8px 20px oklch(0.32 0.12 15 / 0.35)' }}
              onMouseLeave={e => { (e.currentTarget as HTMLAnchorElement).style.transform = 'translateY(0)'; (e.currentTarget as HTMLAnchorElement).style.boxShadow = '0 4px 14px oklch(0.32 0.12 15 / 0.30)' }}
            >
              Volver al inicio
            </a>
          </div>
