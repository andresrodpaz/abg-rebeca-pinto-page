        ...
        {step === 'confirmation' && result && (
          ...
          >
            ...
            <a
              ...
              className="w-full inline-flex items-center justify-center gap-2.5 py-3.5 rounded-xl text-sm font-sans font-semibold mb-4 transition-all duration-200 hover:-translate-y-px"
              style={{
